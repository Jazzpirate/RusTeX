...
pub fn register_primitives_postinit(engine:&mut DefaultEngine<Types>) {
    ...
    register_unexpandable(engine,"rustex@annotateInvisible",CommandScope::Any,invisible_begin);
    register_unexpandable(engine,"rustex@annotateInvisibleEnd",CommandScope::Any,invisible_end);
    // if@rustex
    // rustex@directHTML
}
