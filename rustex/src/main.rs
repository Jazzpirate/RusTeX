...
fn temp_test() {
    ...
    let ret = RusTeXEngine::do_file(
        ...
        "/home/jazzpirate/work/MathHub/courses/Jacobs/GenCS/course/source/codes/slides/ASCII.en.tex",
        true,
        true,
        true,
    );
    ...
    std::fs::write(
        "/home/jazzpirate/work/MathHub/courses/Jacobs/GenCS/course/source/codes/slides/ASCII.en.tex.html",
