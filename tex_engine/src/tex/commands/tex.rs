...
pub fn hyphenation<ET:EngineType>(state: &mut ET::State, gullet:&mut ET::Gullet, stomach:&mut ET::Stomach, cmd:StomachCommand<ET::Token>)
    ...
    // TODO
    catch_prim!(gullet.mouth().read_argument::<ET>(state,&mut |_,_| {}) => ("hyphenation",cmd));
    Ok(())
}
...
pub fn patterns<ET:EngineType>(state: &mut ET::State, gullet:&mut ET::Gullet, stomach:&mut ET::Stomach, cmd:StomachCommand<ET::Token>)
    ...
    // TODO
    catch_prim!(gullet.mouth().read_argument::<ET>(state,&mut |_,_| {}) => ("patterns",cmd));
    Ok(())
}
...
pub fn toks<ET:EngineType>(state:&mut ET::State,gullet:&mut ET::Gullet,cmd:StomachCommand<ET::Token>,global:bool)
    ...
    let mut v = vec!();
    catch_prim!(gullet.mouth().read_until_endgroup::<ET>(state,&mut |_,t| v.push(t)) => ("toks",cmd));
...
pub fn write<ET:EngineType>(state: &mut ET::State, gullet:&mut ET::Gullet, stomach:&mut ET::Stomach, cmd:StomachCommand<ET::Token>)
    ...
    let mut tks = vec!();
    catch_prim!(gullet.mouth().read_until_endgroup::<ET>(state,&mut |_,t| tks.push(t)) => ("write",cmd));
