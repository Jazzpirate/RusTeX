...
pub fn register_primitive_int<E:TeXEngine>(engine:&mut E,names:&[&'static str]) {
    ...
    for name in names {
        let id = PRIMITIVES.get(*name);
        refs.state.register_primitive(refs.aux,id,Command::PrimitiveInt(id));
    }
}
...
pub fn register_primitive_dim<E:TeXEngine>(engine:&mut E,names:&[&'static str]) {
    ...
    for name in names {
        let id = PRIMITIVES.get(*name);
        refs.state.register_primitive(refs.aux,id,Command::PrimitiveDim(id));
    }
}
...
pub fn register_primitive_skip<E:TeXEngine>(engine:&mut E,names:&[&'static str]) {
    ...
    for name in names {
        let id = PRIMITIVES.get(*name);
        refs.state.register_primitive(refs.aux,id,Command::PrimitiveSkip(id));
    }
}
...
pub fn register_primitive_muskip<E:TeXEngine>(engine:&mut E,names:&[&'static str]) {
    ...
    for name in names {
        let id = PRIMITIVES.get(*name);
        refs.state.register_primitive(refs.aux,id,Command::PrimitiveMuSkip(id));
    }
}
...
pub fn register_primitive_toks<E:TeXEngine>(engine:&mut E,names:&[&'static str]) {
    ...
    for name in names {
        let id = PRIMITIVES.get(*name);
        refs.state.register_primitive(refs.aux,id,Command::PrimitiveToks(id));
    }
}
